...
var Validation = {
  validateName: function validateName(validatedProduct) {
  ...
  validatePrice: function validatePrice(validatedProduct) {
  ...
  validateQuantityInInventory: function validateQuantityInInventory(validatedProduct) {
  ...
  validate: function validate(product) {
